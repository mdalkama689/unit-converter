...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful unit convertor calculator tool, check it out: https://seosaurus.in/tools/unit-converter/"
  );

  const toolUrl = "https://seosaurus.in/tools/unit-converter/";
